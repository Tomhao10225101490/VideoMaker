...
口播默认免费 **Edge TTS `zh-CN-YunxiNeural`**（与 [ai_video01](https://github.com/Tomhao10225101490/ai_video01) 同款，无 Key）：按句合成、钩子 `+18%` / 说明 `+10%`、WordBoundary 字幕、`voice_clarity` 后期。断网回退 Piper。画面 `motion_energy: high`。
